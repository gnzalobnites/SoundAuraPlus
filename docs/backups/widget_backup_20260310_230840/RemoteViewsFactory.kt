...
class RemoteViewsFactory(
    ...
    override fun onDataSetChanged() {
        ...
        runBlocking {
            // Por simplicidad, obtenemos las playlists activas primero
            // En una implementación completa, deberías usar los mismos criterios que la app principal
    ...
    override fun getViewAt(position: Int): RemoteViews {
        ...
        views.setTextViewText(R.id.widget_playlist_name, playlist.name)
